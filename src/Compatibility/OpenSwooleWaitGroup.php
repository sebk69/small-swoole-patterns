...
namespace Sebk\SmallSwoolePatterns\Compatibility;

use Swoole\Coroutine\BadMethodCallException;
use Swoole\Coroutine\InvalidArgumentException;
use Swoole\Coroutine\Channel;

class OpenSwooleWaitGroup
{
    protected $chan;
